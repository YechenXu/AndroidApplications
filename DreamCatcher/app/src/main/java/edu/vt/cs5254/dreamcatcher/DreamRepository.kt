...
class DreamRepository @OptIn(DelicateCoroutinesApi::class)
private constructor(
    context: Context,
    ...
    private val database: DreamDatabase = Room
        ...
        .createFromAsset(DATABASE_NAME)// <-- create from asset to load seed data
        .build()

    // Transform the DAO multimap within the Flow:
